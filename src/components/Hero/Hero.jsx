...
const Hero = () => {
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="grid md:grid-cols-2 justify-center items-center md:p-20 lg:px-40 p-15 flex-1 mx-auto w-full max-w-7xl">
        <div className="flex justify-center flex-col gap-4">
          <h1 className="text-3xl md:text-6xl font-bold text-gray-800">
            Welcome <span className="text-orange-700">Home</span> - Discover
            More
          </h1>
          <hr className="border-2 w-25 text-orange-700" />
          <p className="text-gray-800">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur
            quaerat aut fugit laboriosam facilis rem vero, culpa ipsa dolorum
            unde sunt error, amet? Fugit! Reprehenderit!
          </p>
          <button className="bg-orange-700 w-fit px-4 py-2 rounded-md text-white font-bold cursor-pointer hover:bg-orange-800">
            <Link to={"/signup"}> Continue </Link>
          </button>
        </div>
        <div>
          <img
            className="hidden h-100 w-100 md:block"
            src={hero}
            alt="Hero Img"
          />
        </div>
